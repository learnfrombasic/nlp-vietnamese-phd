...
def predict_language(translator: Translator, text: str) -> str:
...
result = predict_language(translator, text)
...
if __name__ == "__main__":
    ...
    text = "Hôm nay là ngày chủ nhật."
    predict_language(translator, text)